...
ggplot(data = filter(nh.nf2.beds.ruca, year != 2005), aes(as.character(year), nh.nf2.beds.pct.change, fill = Dem_Desc, group = Dem_Desc)) +
  ...
  labs(x="", y = "", color="", title = "Percent change in the number of skilled\nnursing beds since 2005", subtitle = "The most severe declines have occurred in rural Minnesota")+
...
ggsave(filename = "Charts/Paper report/sn-beds-ruca.png", dpi = "print", width = 6, height = 4)

ggsave(filename = "Charts/Paper report/sn-beds-ruca.pdf", device = cairo_pdf, dpi = "print", width = 6, height = 4)
