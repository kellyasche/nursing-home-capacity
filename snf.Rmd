...
Next we will assess how much change there's been in the assisted living capacity. MN Department of Health only started licensing these since 2021 so let's see what kind of data we have here.

<br>

```{r master assisted living}
master.al <- master.original
