...
Okay, next let's see if there are any changes to the number of facilities. Essentially, is the decline of bed capacity due to a decline in facilities, or is it facilities themselves that are shutting down some of their wings. This matters because if the facilities still exist, it means that it's possible regions could see an increase in beds if needed.
