...
Since nearly all counties only have 100% of their beds as dual eligible, let's focus only on the 7 counties that are not 100%. Questions that rise are whether they are experiencing declines in only the dual eligible beds or is it pretty equal across the payment eligibility.
